...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    <div className="appShell" onClick={onShellClick}>
      <FlowerBackground flowers={flowers} />

      <div className="appContent">
        <Routes>
          <Route path="/" element={<Home onClearFlowers={clearFlowers} />} />
          <Route path="/main" element={<Main />} />
          <Route path="*" element={<Navigate to="/" replace />} />
        </Routes>
        <button onClick={() => setTheme(theme === "beige" ? "purple" : "beige")} className="themeBtn">
        ✧
      </button>
      </div>
